#program to make scientific calculator//
from tkinter import *
import math
...
# sets the background color of the calculator as white
root.configure(background = 'black')
# sets the geometry
root.geometry("480x565+500+90")
# holds the buttons in the calculator, act as a container for numbers and operators
calc = Frame(root)
# create a grid like pattern of the frame i.e buttons
calc.grid()
class Calc():
    def _init_(self):
        self.total = 0
...
btnsq = Button(calc, text="\u221A", width=6,
               ...
               font=('Helvetica', 20, 'bold'),
               bd=8, command=added_value.squared).grid(
...
btnPi = Button(calc, text="pi", width=6,
               ...
               bd=3, command=added_value.pi
               ).grid(row=1, column=4, pady=1)
btnCos = Button(calc, text="cos", width=6,
                height=2, bg='grey', fg='black',
                font=('Helvetica', 20, 'bold','italic'),
                bd=3, command=added_value.cos
                ).grid(row=1, column=6, pady=1)
btntan = Button(calc, text="tan", width=6,
                height=2, bg='grey', fg='black',
                font=('Helvetica', 20, 'bold','italic'),
                bd=3, command=added_value.tan
                ).grid(row=1, column=7, pady=1)
btnsin = Button(calc, text="sin", width=6,
                height=2, bg='grey', fg='black',
                font=('Helvetica', 20, 'bold','italic'),
                bd=3, command=added_value.sin
                ).grid(row=1, column=5, pady=1)
# ROW 2 :
btn2Pi = Button(calc, text="2pi", width=6,
                height=2, bg='grey', fg='black',
                font=('Helvetica', 20, 'bold','italic'),
                bd=3, command=added_value.tau
                ).grid(row=2, column=4, pady=1)
btnCosh = Button(calc, text="cos h", width=6,
                 height=2, bg='grey', fg='black',
                 font=('Helvetica', 20, 'bold','italic'),
                 bd=3, command=added_value.cosh
                 ).grid(row=2, column=6, pady=1)
btntanh = Button(calc, text="tan h", width=6,
                 height=2, bg='grey', fg='black',
                 font=('Helvetica', 20, 'bold','italic'),
                 bd=3, command=added_value.tanh
                 ).grid(row=2, column=7, pady=1)
btnsinh = Button(calc, text="sin h", width=6,
                 height=2, bg='grey', fg='black',
                 font=('Helvetica', 20, 'bold','italic'),
                 bd=3, command=added_value.sinh
                 ).grid(row=2, column=5, pady=1)
# ROW 3 :
btnlog = Button(calc, text="log", width=6,
                height=2, bg='grey', fg='black',
                font=('Helvetica', 20, 'bold','italic'),
                bd=3, command=added_value.log
                ).grid(row=3, column=4, pady=1)
btnExp = Button(calc, text="exp", width=6,
                height=2, bg='grey', fg='black',
                font=('Helvetica', 20, 'bold','italic'),
                bd=3, command=added_value.exp
                ).grid(row=3, column=5, pady=1)
btnMod = Button(calc, text="Mod", width=6,
                height=2, bg='grey', fg='black',
                font=('Helvetica', 20, 'bold','italic'),
                bd=3, command=lambda: added_value.operation("mod")
                ).grid(row=3, column=6, pady=1)
btnE = Button(calc, text="e", width=6,
              height=2, bg='grey', fg='black',
              font=('Helvetica', 20, 'bold','italic'),
              bd=3, command=added_value.e
              ).grid(row=3, column=7, pady=1)
# ROW 4 :
btnlog10 = Button(calc, text="log10", width=6,
                  height=2, bg='grey', fg='black',
                  font=('Helvetica', 20, 'bold','italic'),
                  bd=3, command=added_value.log10
                  ).grid(row=4, column=4, pady=1)
btncos = Button(calc, text="log1p", width=6,
                height=2, bg='grey', fg='black',
                font=('Helvetica', 20, 'bold','italic'),
                bd=3, command=added_value.log1p
                ).grid(row=4, column=5, pady=1)
btnexpm1 = Button(calc, text="expm1", width=6,
                  height=2, bg='grey', fg='black',
                  font=('Helvetica', 20, 'bold','italic'),
                  bd=3, command=added_value.expm1
                  ).grid(row=4, column=6, pady=1)
btngamma = Button(calc, text="gamma", width=6,
                  height=2, bg='grey', fg='black',
                  font=('Helvetica', 20, 'bold','italic'),
                  bd=3, command=added_value.lgamma
                  ).grid(row=4, column=7, pady=1)
# ROW 5 :
btnlog2 = Button(calc, text="log2", width=6,
                 height=2, bg='grey', fg='black',
                 font=('Helvetica', 20, 'bold','italic'),
                 bd=3, command=added_value.log2
                 ).grid(row=5, column=4, pady=1)
btndeg = Button(calc, text="deg", width=6,
                height=2, bg='grey', fg='black',
                font=('Helvetica', 20, 'bold','italic'),
                bd=3, command=added_value.degrees
                ).grid(row=5, column=5, pady=1)
btnacosh = Button(calc, text="acosh", width=6,
                  height=2, bg='grey', fg='black',
                  font=('Helvetica', 20, 'bold','italic'),
                  bd=3, command=added_value.acosh
                  ).grid(row=5, column=6, pady=1)
btnasinh = Button(calc, text="asinh", width=6,
                  height=2, bg='grey', fg='black',
                  font=('Helvetica', 20, 'italic','bold'),
                  bd=3, command=added_value.asinh
...
moremenu.add_command(label="Cut")
moremenu.add_command(label="Copy")
moremenu.add_command(label="Paste")
# Menubar 3 :
